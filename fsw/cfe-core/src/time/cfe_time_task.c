...
void CFE_TIME_TaskMain(void)
{
    ...
    while (Status == CFE_SUCCESS)
    {
        ...
        Status = CFE_SB_ReceiveBuffer(&SBBufPtr, CFE_TIME_TaskData.CmdPipe, CFE_SB_PEND_FOREVER);
...
int32 CFE_TIME_TaskInit(void)
{
    ...
    Status = OS_BinSemCreate(&CFE_TIME_TaskData.ToneSemaphore, CFE_TIME_SEM_TONE_NAME, CFE_TIME_SEM_VALUE,
    ...
    Status = OS_BinSemCreate(&CFE_TIME_TaskData.LocalSemaphore, CFE_TIME_SEM_1HZ_NAME, CFE_TIME_SEM_VALUE,
                             CFE_TIME_SEM_OPTIONS);
    if (Status != CFE_SUCCESS)
    {
    ...
    Status = CFE_ES_CreateChildTask(&CFE_TIME_TaskData.ToneTaskID, CFE_TIME_TASK_TONE_NAME, CFE_TIME_Tone1HzTask,
    ...
    Status = CFE_ES_CreateChildTask(&CFE_TIME_TaskData.LocalTaskID, CFE_TIME_TASK_1HZ_NAME, CFE_TIME_Local1HzTask,
    ...
    Status = CFE_SB_CreatePipe(&CFE_TIME_TaskData.CmdPipe, CFE_TIME_TaskData.PipeDepth, CFE_TIME_TaskData.PipeName);
    if (Status != CFE_SUCCESS)
    {
    ...
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_SEND_HK_MID), CFE_TIME_TaskData.CmdPipe);
    if (Status != CFE_SUCCESS)
    {
...
*/
    ...
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_TONE_CMD_MID), CFE_TIME_TaskData.CmdPipe);
#endif

#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    Status = CFE_SB_SubscribeLocal(CFE_SB_ValueToMsgId(CFE_TIME_TONE_CMD_MID), CFE_TIME_TaskData.CmdPipe, 4);
#endif
    if (Status != CFE_SUCCESS)
    {
...
*/
#if (CFE_PLATFORM_TIME_CFG_CLIENT == true)
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_DATA_CMD_MID), CFE_TIME_TaskData.CmdPipe);
#endif

#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    Status = CFE_SB_SubscribeLocal(CFE_SB_ValueToMsgId(CFE_TIME_DATA_CMD_MID), CFE_TIME_TaskData.CmdPipe, 4);
#endif
    if (Status != CFE_SUCCESS)
    {
...
*/
#if (CFE_PLATFORM_TIME_CFG_CLIENT == true)
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_1HZ_CMD_MID), CFE_TIME_TaskData.CmdPipe);
#endif

#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    Status = CFE_SB_SubscribeLocal(CFE_SB_ValueToMsgId(CFE_TIME_1HZ_CMD_MID), CFE_TIME_TaskData.CmdPipe, 4);
#endif
...
*/
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_SEND_CMD_MID), CFE_TIME_TaskData.CmdPipe);
    if (Status != CFE_SUCCESS)
    {
    ...
    */
    Status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(CFE_TIME_CMD_MID), CFE_TIME_TaskData.CmdPipe);
    if (Status != CFE_SUCCESS)
    {
...
int32 CFE_TIME_HousekeepingCmd(const CFE_MSG_CommandHeader_t *data)
{
    ...
    */
    CFE_SB_TimeStampMsg(&CFE_TIME_TaskData.HkPacket.TlmHeader.Msg);
    CFE_SB_TransmitMsg(&CFE_TIME_TaskData.HkPacket.TlmHeader.Msg, true);
...
int32 CFE_TIME_ResetCountersCmd(const CFE_TIME_ResetCountersCmd_t *data)
{
     ...
     */
    CFE_TIME_TaskData.ResetVersionCounter = CFE_TIME_TaskData.LastVersionCounter;
...
int32 CFE_TIME_SendDiagnosticTlm(const CFE_TIME_SendDiagnosticCmd_t *data)
{
    ...
    */
    CFE_SB_TimeStampMsg(&CFE_TIME_TaskData.DiagPacket.TlmHeader.Msg);
    CFE_SB_TransmitMsg(&CFE_TIME_TaskData.DiagPacket.TlmHeader.Msg, true);
