...
*/
    ...
    */
    ...
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Seconds     = CFE_MAKE_BIG32(NewMET.Seconds);
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Subseconds  = CFE_MAKE_BIG32(NewMET.Subseconds);
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneSTCF.Seconds    = CFE_MAKE_BIG32(Reference.AtToneSTCF.Seconds);
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneSTCF.Subseconds = CFE_MAKE_BIG32(Reference.AtToneSTCF.Subseconds);
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneLeapSeconds     = CFE_MAKE_BIG16(Reference.AtToneLeapSeconds);
    CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneState           = CFE_MAKE_BIG16(AtToneState);
        ...
        */
        ...
        else
        {
            ...
            */
            ...
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneLeapSeconds = CFE_MAKE_BIG16(Reference.AtToneLeapSeconds);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneState       = CFE_MAKE_BIG16(ClockState);
        ...
        */
        ...
        else
        {
            ...
            */
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Seconds     = CFE_MAKE_BIG32(NewMET.Seconds);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Subseconds  = CFE_MAKE_BIG32(NewMET.Subseconds);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneSTCF.Seconds    = CFE_MAKE_BIG32(NewSTCF.Seconds);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneSTCF.Subseconds = CFE_MAKE_BIG32(NewSTCF.Subseconds);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneLeapSeconds     = CFE_MAKE_BIG16(NewLeaps);
            CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneState           = CFE_MAKE_BIG16(ClockState);
...
void CFE_TIME_ToneData(const CFE_TIME_ToneDataCmd_Payload_t *ToneDataCmd)
{
    ...
    */
    CFE_TIME_TaskData.PendingMET.Seconds     = CFE_MAKE_BIG32(ToneDataCmd->AtToneMET.Seconds);
    CFE_TIME_TaskData.PendingMET.Subseconds  = CFE_MAKE_BIG32(ToneDataCmd->AtToneMET.Subseconds);
    CFE_TIME_TaskData.PendingSTCF.Seconds    = CFE_MAKE_BIG32(ToneDataCmd->AtToneSTCF.Seconds);
    CFE_TIME_TaskData.PendingSTCF.Subseconds = CFE_MAKE_BIG32(ToneDataCmd->AtToneSTCF.Subseconds);
...
*/
    ...
    CFE_TIME_ToneVerify(CFE_TIME_TaskData.ToneSignalLatch, CFE_TIME_TaskData.ToneDataLatch);
#endif
...
*/
#if (CFE_MISSION_TIME_AT_TONE_WILL_BE == true)
    CFE_TIME_ToneVerify(CFE_TIME_TaskData.ToneDataLatch, CFE_TIME_TaskData.ToneSignalLatch);
#endif
    ...
    */
    ...
    else
    {
        ...
        else
        {
            ...
            */
            if ((elapsed.Seconds != 0) || (elapsed.Subseconds < CFE_TIME_TaskData.MinElapsed) ||
...
void CFE_TIME_Tone1HzISR(void)
{
    ...
    */
    Result = CFE_TIME_Compare(ToneSignalLatch, CFE_TIME_TaskData.ToneSignalLatch);
    ...
    if (Result == CFE_TIME_A_LT_B)
    {
        ...
        ** Local clock has rolled over...
        */
        Elapsed = CFE_TIME_Subtract(CFE_TIME_TaskData.MaxLocalClock, CFE_TIME_TaskData.ToneSignalLatch);
...
*/
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    if ((CFE_TIME_TaskData.OneHzAdjust.Seconds != 0) || (CFE_TIME_TaskData.OneHzAdjust.Subseconds != 0))
    {
        CFE_TIME_SysTime_t NewSTCF;
        NextState = CFE_TIME_StartReferenceUpdate();
        ...
        {
            NewSTCF = CFE_TIME_Add(NextState->AtToneSTCF, CFE_TIME_TaskData.OneHzAdjust);
        }
        else
        {
            NewSTCF = CFE_TIME_Subtract(NextState->AtToneSTCF, CFE_TIME_TaskData.OneHzAdjust);
        }
