...
**                         that will be filled with the processor specific Table Name. *FullTblName is the processor
*specific Table Name of the form "AppName.TblName".
**
...
**                               address of the first byte of the working buffer. *WorkingBufferPtr is the address of
*the first byte of the working buffer
**
...
**                               of the file's standard cFE Header. *StdFileHeaderPtr is the contents of the standard
*cFE File Header
**
