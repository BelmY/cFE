...
*wishes
**                                                                 to specify their own block of memory as the Dump Only
*table,
**                                                                 they need to also include the
*#CFE_TBL_OPT_USR_DEF_ADDR option
**                                                                 explained below.
**                                 \arg #CFE_TBL_OPT_NOT_USR_DEF - When this option is selected, Table Services
*allocates
**                                                                 memory for the table and, in the case of a double
*buffered
**                                                                 table, it allocates the same amount of memory again
*for the
**                                                                 second buffer.  This option is mutually exclusive
*with
...
*Services
**                                                                 will require the Application to identify the location
*of the
**                                                                 active table buffer via the #CFE_TBL_Load function.
*This
...
*Data Store (CDS)
**                                                                 for the table and insure that the contents in the CDS
*are the same
**                                                                 as the contents of the currently active buffer for
*the table.
**                                                                 This option is mutually exclusive of the
*#CFE_TBL_OPT_USR_DEF_ADDR
**                                                                 and #CFE_TBL_OPT_DUMP_ONLY options.  It should also
*be noted that
**                                                                 the use of this option with double buffered tables
*will prevent
**                                                                 the update of the double buffered table from being
*quick and
**                                                                 it could be blocked.  Therefore, critical tables
*should not be
...
*first byte of data associated with the
**                       specified tables.
**
...
*characteristics and registry information stored in
