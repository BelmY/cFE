...
void EVS_AddLog(CFE_EVS_LongEventTlm_t *EVS_PktPtr)
{
    ...
    if (CFE_EVS_GlobalData.EVS_TlmPkt.Payload.LogEnabled == true)
    {
        ...
        else
        {
            ...
            memcpy(&CFE_EVS_GlobalData.EVS_LogPtr->LogEntry[CFE_EVS_GlobalData.EVS_LogPtr->Next], EVS_PktPtr,
                   sizeof(*EVS_PktPtr));
...
void EVS_ClearLog(void)
{
    ...
    memset(CFE_EVS_GlobalData.EVS_LogPtr->LogEntry, 0, sizeof(CFE_EVS_GlobalData.EVS_LogPtr->LogEntry));
...
int32 CFE_EVS_WriteLogDataFileCmd(const CFE_EVS_WriteLogDataFileCmd_t *data)
{
    ...
    {
        EVS_SendEvent(CFE_EVS_NO_LOGWR_EID, CFE_EVS_EventType_ERROR, "Write Log Command: Event Log is Disabled");
    ...
    else
    {
        ...
        else
        {
            ...
            if (BytesWritten == sizeof(LogFileHdr))
            {
                ...
                {
                    BytesWritten = OS_write(LogFileHandle, &CFE_EVS_GlobalData.EVS_LogPtr->LogEntry[LogIndex],
...
int32 CFE_EVS_SetLogModeCmd(const CFE_EVS_SetLogModeCmd_t *data)
{
    ...
    else
    {
        ...
        EVS_SendEvent(CFE_EVS_NO_LOGSET_EID, CFE_EVS_EventType_ERROR, "Set Log Mode Command: Event Log is Disabled");
    }
