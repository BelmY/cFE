        ...
        else
        {
                     ...
                     (CFE_EVS_GlobalData.EVS_LogPtr->Next >= CFE_PLATFORM_EVS_LOG_MAX))
            {
                CFE_ES_WriteToSysLog(
                    ...
                    (int)CFE_EVS_GlobalData.EVS_LogPtr->LogCount, (int)CFE_EVS_GlobalData.EVS_LogPtr->LogFullFlag,
...
void CFE_EVS_TaskMain(void)
{
    ...
    while (Status == CFE_SUCCESS)
    {
        ...
        Status = CFE_SB_ReceiveBuffer(&SBBufPtr, CFE_EVS_GlobalData.EVS_CommandPipe, CFE_SB_PEND_FOREVER);
...
int32 CFE_EVS_TaskInit(void)
{
    ...
    Status = CFE_SB_CreatePipe(&CFE_EVS_GlobalData.EVS_CommandPipe, CFE_EVS_PIPE_DEPTH, CFE_EVS_PIPE_NAME);
    if (Status != CFE_SUCCESS)
    {
...
int32 CFE_EVS_ClearLogCmd(const CFE_EVS_ClearLogCmd_t *data)
{
    ...
    {
        EVS_SendEvent(CFE_EVS_NO_LOGCLR_EID, CFE_EVS_EventType_ERROR, "Clear Log Command: Event Log is Disabled");
