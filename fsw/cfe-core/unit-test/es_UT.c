                            ...
                            CFE_ES_AppRecord_t **OutAppRec, CFE_ES_TaskRecord_t **OutTaskRec)
{
    ...
    CFE_ES_Global.LastAppId = CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(UtAppId) + 1);
    ...
    if (AppName)
    {
        strncpy(LocalAppPtr->StartParams.BasicInfo.Name, AppName, sizeof(LocalAppPtr->StartParams.BasicInfo.Name) - 1);
...
void ES_UT_SetupSingleLibId(const char *LibName, CFE_ES_LibRecord_t **OutLibRec)
{
    ...
    CFE_ES_Global.LastLibId = CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(UtLibId) + 1);
    ...
    if (LibName)
    {
        strncpy(LocalLibPtr->BasicInfo.Name, LibName, sizeof(LocalLibPtr->BasicInfo.Name) - 1);
...
void ES_UT_SetupMemPoolId(CFE_ES_MemPoolRecord_t **OutPoolRecPtr)
{
    ...
    CFE_ES_Global.LastMemPoolId = CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(UtPoolID) + 1);
...
void ES_UT_SetupSingleCDSRegistry(const char *CDSName, size_t BlockSize, bool IsTable, CFE_ES_CDS_RegRec_t **OutRegRec)
{
    ...
    CFE_ES_Global.CDSVars.LastCDSBlockId = CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(UtCDSID) + 1);
...
void TestInit(void)
{
    ...
    CFE_ES_Main(CFE_PSP_RST_TYPE_POWERON, CFE_PSP_RST_SUBTYPE_POWER_CYCLE, 1, CFE_PLATFORM_ES_NONVOL_STARTUP_FILE);
...
void TestStartupErrorPaths(void)
{
    ...
    CFE_ES_Main(CFE_PSP_RST_TYPE_POWERON, 1, 1, CFE_PLATFORM_ES_NONVOL_STARTUP_FILE);
    ...
    UT_SetHookFunction(UT_KEY(OS_TaskCreate), ES_UT_SetAppStateHook, NULL);
    CFE_ES_Main(CFE_PSP_RST_TYPE_POWERON, 1, 1, (char *)CFE_PLATFORM_ES_NONVOL_STARTUP_FILE);
    ...
    CFE_ES_InitializeFileSystems(CFE_PSP_RST_TYPE_PROCESSOR);
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_MOUNT_VOLATILE]) && UT_GetStubCount(UT_KEY(OS_printf)) == 2,
              "CFE_ES_InitializeFileSystems", "Processor reset; truncate free block count");
    ...
    UT_Report(__FILE__, __LINE__, UT_GetStubCount(UT_KEY(OS_printf)) == 0, "CFE_ES_InitializeFileSystems",
    ...
    CFE_ES_InitializeFileSystems(CFE_PSP_RST_TYPE_PROCESSOR);
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_DETERMINE_BLOCKS]) && UT_GetStubCount(UT_KEY(OS_printf)) == 1,
    ...
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_RECORD_USED]) && UT_GetStubCount(UT_KEY(OS_printf)) == 13,
              "CFE_ES_CreateObjects", "Record used error");
    ...
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_RECORD_USED]) &&
                  UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_EARLYINIT]) && UT_GetStubCount(UT_KEY(OS_printf)) == 14,
    ...
    CFE_ES_CreateObjects();
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_CORE_APP_CREATE]) && UT_GetStubCount(UT_KEY(OS_printf)) == 18,
              "CFE_ES_CreateObjects", "Error creating core application");
    ...
    UT_Report(__FILE__, __LINE__, UT_GetStubCount(UT_KEY(OS_printf)) == 18, "CFE_ES_CreateObjects",
    ...
    UT_Report(__FILE__, __LINE__, UT_GetStubCount(UT_KEY(OS_printf)) == 19, "CFE_ES_CreateObjects",
...
void TestApps(void)
{
    ...
    ES_ResetUnitTest();
    UT_Report(__FILE__, __LINE__, CFE_ES_ParseFileEntry(NULL, 0) == CFE_ES_ERR_APP_CREATE, "CFE_ES_ParseFileEntry",
              "Invalid file entry");
    ...
    ES_ResetUnitTest();
    Return = CFE_ES_AppCreate(&Id, NULL, "EntryPoint", "AppName", 170, 4096, 1);
    ...
    Return                             = CFE_ES_AppCreate(&Id, "ut/filename.x", "EntryPoint", NameBuffer, 170, 4096, 1);
    ...
    Return = CFE_ES_AppCreate(&Id, "ut/filename.x", "EntryPoint", "AppName2", 170, 8192, 1);
    UtAssert_INT32_EQ(Return, CFE_STATUS_EXTERNAL_RESOURCE_FAIL);
    ...
    ES_ResetUnitTest();
    ES_UT_SetupSingleAppId(CFE_ES_AppType_EXTERNAL, CFE_ES_AppState_RUNNING, NULL, &UtAppRecPtr, NULL);
    strncpy((char *)UtAppRecPtr->StartParams.BasicInfo.FileName, "/ram/Filename", OS_MAX_PATH_LEN);
    UtAppRecPtr->StartParams.BasicInfo.FileName[OS_MAX_PATH_LEN - 1] = '\0';
    strncpy((char *)UtAppRecPtr->StartParams.BasicInfo.EntryPoint, "NotNULL", OS_MAX_API_NAME);
    UtAppRecPtr->StartParams.BasicInfo.EntryPoint[OS_MAX_API_NAME - 1] = '\0';
    ...
    strncpy((char *)UtAppRecPtr->StartParams.BasicInfo.FileName, "/ram/FileName", OS_MAX_PATH_LEN);
    UtAppRecPtr->StartParams.BasicInfo.FileName[OS_MAX_PATH_LEN - 1] = '\0';
    strncpy((char *)UtAppRecPtr->StartParams.BasicInfo.EntryPoint, "NULL", OS_MAX_API_NAME);
    UtAppRecPtr->StartParams.BasicInfo.EntryPoint[OS_MAX_API_NAME - 1] = '\0';
    UtAppRecPtr->StartParams.Priority                                  = 255;
    UtAppRecPtr->StartParams.StackSize                                 = 8192;
    UtAppRecPtr->StartParams.ExceptionAction                           = 0;
    ...
    ES_UT_SetupSingleAppId(CFE_ES_AppType_EXTERNAL, CFE_ES_AppState_RUNNING, NULL, &UtAppRecPtr, NULL);
    Id = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_GetAppInfo(&AppInfo, Id) == CFE_SUCCESS, "CFE_ES_GetAppInfo",
    ...
    ES_UT_SetupSingleAppId(CFE_ES_AppType_EXTERNAL, CFE_ES_AppState_RUNNING, NULL, &UtAppRecPtr, NULL);
    Id = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_GetAppInfo(NULL, Id) == CFE_ES_ERR_BUFFER, "CFE_ES_GetAppInfo",
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_GetAppInfo(&AppInfo, Id) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
    ...
    Id = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanUpApp(Id) == CFE_ES_APP_CLEANUP_ERR, "CFE_ES_CleanUpApp",
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_MutSemDelete), 1, OS_ERROR);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_MUT_SEM_DELETE_ERR,
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_BIN_SEM_DELETE_ERR,
    ...
    Id = CFE_ES_TaskRecordGetID(UtTaskRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_COUNT_SEM_DELETE_ERR,
    ...
    Id = CFE_ES_TaskRecordGetID(UtTaskRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_QUEUE_DELETE_ERR,
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_TIMER_DELETE_ERR,
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_close), OS_ERROR);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) != CFE_SUCCESS, "CFE_ES_CleanupTaskResources",
              "File close failure");
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_TimerGetInfo), 1, OS_ERROR);
    UT_SetDefaultReturnValue(UT_KEY(OS_TaskDelete), OS_ERROR);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanupTaskResources(Id) == CFE_ES_TASK_DELETE_ERR,
    ...
    Id = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_CleanUpApp(Id) == CFE_SUCCESS, "CFE_ES_CleanUpApp",
    ...
    Id = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__,
              CFE_ES_CleanUpApp(Id) == CFE_SUCCESS && !CFE_ES_TaskRecordIsUsed(UtTaskRecPtr) &&
...
void TestResourceID(void)
{
    ...
    UtAssert_True(CFE_ES_ResourceID_ToInteger(Id) < (CFE_ES_APPID_BASE + CFE_PLATFORM_ES_MAX_APPLICATIONS),
                  "CFE_ES_FindNextAvailableId() wrap ID");
}
...
void TestLibs(void)
{
    ...
    Return = CFE_ES_LoadLibrary(&Id, "filename", "EntryPoint", &LongLibraryName[0]);
    UT_Report(__FILE__, __LINE__, Return == CFE_ES_BAD_ARGUMENT, "CFE_ES_LoadLibrary",
    ...
    UT_InitData();
    UT_SetDummyFuncRtn(OS_SUCCESS);
    Return = CFE_ES_LoadLibrary(&Id, "/cf/apps/tst_lib.bundle", "TST_LIB_Init", "TST_LIB");
    ...
    Return = CFE_ES_LoadLibrary(&Id, "/cf/apps/tst_lib.bundle", "dummy_function", "TST_LIB");
    ...
    {
        CFE_ES_LibRecordSetUsed(UtLibRecPtr, ES_UT_MakeLibIdForIndex(j));
        ++UtLibRecPtr;
    }
    ...
    UtAssert_INT32_EQ(CFE_ES_GetLibName(LongLibraryName, CFE_ES_RESOURCEID_UNDEFINED, sizeof(LongLibraryName)),
...
void TestTask(void)
{
    ...
    UT_Report(__FILE__, __LINE__, UT_GetStubCount(UT_KEY(OS_printf)) == 2, "CFE_ES_TaskMain",
    ...
    ES_ResetUnitTest();
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppFileName, "filename", sizeof(CmdBuf.StartAppCmd.Payload.AppFileName));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppEntryPoint, "entrypoint",
            sizeof(CmdBuf.StartAppCmd.Payload.AppEntryPoint));
    memset(CmdBuf.StartAppCmd.Payload.Application, 'x', sizeof(CmdBuf.StartAppCmd.Payload.Application));
    ...
    ES_ResetUnitTest();
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppFileName, "123", sizeof(CmdBuf.StartAppCmd.Payload.AppFileName));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppEntryPoint, "entrypoint",
            sizeof(CmdBuf.StartAppCmd.Payload.AppEntryPoint));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.Application, "appName", sizeof(CmdBuf.StartAppCmd.Payload.Application));
    CmdBuf.StartAppCmd.Payload.Priority        = 160;
    ...
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppFileName, "filename", sizeof(CmdBuf.StartAppCmd.Payload.AppFileName));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppEntryPoint, "", sizeof(CmdBuf.StartAppCmd.Payload.AppEntryPoint));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.Application, "appName", sizeof(CmdBuf.StartAppCmd.Payload.Application));
    CmdBuf.StartAppCmd.Payload.Priority        = 160;
    CmdBuf.StartAppCmd.Payload.StackSize       = CFE_ES_MEMOFFSET_C(12096);
    CmdBuf.StartAppCmd.Payload.ExceptionAction = CFE_ES_ExceptionAction_RESTART_APP;
    ...
    strncpy((char *)CmdBuf.StartAppCmd.Payload.AppEntryPoint, "entrypoint",
            sizeof(CmdBuf.StartAppCmd.Payload.AppEntryPoint));
    strncpy((char *)CmdBuf.StartAppCmd.Payload.Application, "", sizeof(CmdBuf.StartAppCmd.Payload.Application));
    CmdBuf.StartAppCmd.Payload.Priority        = 160;
    CmdBuf.StartAppCmd.Payload.StackSize       = CFE_ES_MEMOFFSET_C(12096);
    CmdBuf.StartAppCmd.Payload.ExceptionAction = CFE_ES_ExceptionAction_RESTART_APP;
    UT_CallTaskPipe(CFE_ES_TaskPipe, &CmdBuf.Msg, sizeof(CmdBuf.StartAppCmd), UT_TPID_CFE_ES_CMD_START_APP_CC);
    ...
    strncpy((char *)CmdBuf.StopAppCmd.Payload.Application, "CFE_ES", sizeof(CmdBuf.StopAppCmd.Payload.Application));
    ...
    strncpy((char *)CmdBuf.ReloadAppCmd.Payload.Application, "CFE_ES", sizeof(CmdBuf.ReloadAppCmd.Payload.Application));
    ...
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    ES_UT_SetupSingleAppId(CFE_ES_AppType_CORE, CFE_ES_AppState_WAITING, "CFE_ES", NULL, NULL);
    strncpy((char *)CmdBuf.QueryOneCmd.Payload.Application, "CFE_ES", sizeof(CmdBuf.QueryOneCmd.Payload.Application));
    ...
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    ES_UT_SetupSingleAppId(CFE_ES_AppType_CORE, CFE_ES_AppState_RUNNING, "CFE_ES", NULL, NULL);
    strncpy((char *)CmdBuf.QueryAllCmd.Payload.FileName, "AllFilename", sizeof(CmdBuf.QueryAllCmd.Payload.FileName));
    ...
    ES_ResetUnitTest();
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy((char *)CmdBuf.WriteSysLogCmd.Payload.FileName, "filename", sizeof(CmdBuf.WriteSysLogCmd.Payload.FileName));
    ...
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    UT_SetDefaultReturnValue(UT_KEY(OS_OpenCreate), OS_ERROR);
    strncpy((char *)CmdBuf.WriteSysLogCmd.Payload.FileName, "", sizeof(CmdBuf.WriteSysLogCmd.Payload.FileName));
    UT_CallTaskPipe(CFE_ES_TaskPipe, &CmdBuf.Msg, sizeof(CmdBuf.WriteSysLogCmd), UT_TPID_CFE_ES_CMD_WRITE_SYSLOG_CC);
    ...
    ES_ResetUnitTest();
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy(CmdBuf.WriteERLogCmd.Payload.FileName, "filename", sizeof(CmdBuf.WriteERLogCmd.Payload.FileName));
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_TaskData.BackgroundERLogDumpState.IsPending, "CFE_ES_WriteERLogCmd",
    ...
    UT_Report(__FILE__, __LINE__, !CFE_ES_RunERLogDump(0, &CFE_ES_TaskData.BackgroundERLogDumpState),
              "CFE_ES_RunERLogDump", "Write E&R log; not pending");
    UT_Report(__FILE__, __LINE__, !UT_EventIsInHistory(CFE_ES_ERLOG2_EID), "CFE_ES_WriteERLogCmd",
    ...
    UT_Report(__FILE__, __LINE__, !CFE_ES_TaskData.BackgroundERLogDumpState.IsPending, "CFE_ES_RunERLogDump",
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_OpenCreate), OS_ERROR);
    CFE_ES_RunERLogDump(0, &CFE_ES_TaskData.BackgroundERLogDumpState);
    UT_Report(__FILE__, __LINE__, UT_EventIsInHistory(CFE_ES_ERLOG2_ERR_EID), "CFE_ES_RunERLogDump",
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_write), OS_ERROR);
    CFE_ES_RunERLogDump(0, &CFE_ES_TaskData.BackgroundERLogDumpState);
    UT_Report(__FILE__, __LINE__, UT_EventIsInHistory(CFE_ES_FILEWRITE_ERR_EID), "CFE_ES_RunERLogDump",
    ...
    UT_SetDeferredRetcode(UT_KEY(CFE_FS_WriteHeader), 1, OS_ERROR);
    CFE_ES_RunERLogDump(0, &CFE_ES_TaskData.BackgroundERLogDumpState);
    UT_Report(__FILE__, __LINE__, UT_EventIsInHistory(CFE_ES_FILEWRITE_ERR_EID), "CFE_ES_WriteERLogCmd",
    ...
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy(CmdBuf.DeleteCDSCmd.Payload.CdsName, "CFE_ES.CDS_NAME", sizeof(CmdBuf.DeleteCDSCmd.Payload.CdsName));
...
void TestPerf(void)
{
    ...
    /* clearing the BackgroundPerfDumpState will fully reset to initial state */
    memset(&CFE_ES_TaskData.BackgroundPerfDumpState, 0, sizeof(CFE_ES_TaskData.BackgroundPerfDumpState));
    strncpy(CmdBuf.PerfStopCmd.Payload.DataFileName, "filename", sizeof(CmdBuf.PerfStopCmd.Payload.DataFileName));
    UT_CallTaskPipe(CFE_ES_TaskPipe, &CmdBuf.Msg, sizeof(CmdBuf.PerfStopCmd), UT_TPID_CFE_ES_CMD_STOP_PERF_DATA_CC);
    UT_Report(__FILE__, __LINE__, UT_EventIsInHistory(CFE_ES_PERF_STOPCMD_EID), "CFE_ES_StopPerfDataCmd",
...
void TestAPI(void)
{
    ...
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_CORE_RUNTIME]) && UT_GetStubCount(UT_KEY(OS_printf)) == 1,
              "CFE_ES_ExitApp", "Application runtime error");
    ...
    CFE_ES_ExitApp(1000);
    UT_Report(__FILE__, __LINE__,
              UT_PrintfIsInHistory(UT_OSP_MESSAGES[UT_OSP_CORE_APP_EXIT]) && UT_GetStubCount(UT_KEY(OS_printf)) == 2,
              "CFE_ES_ExitApp", "Application exit error");
    ...
    ES_ResetUnitTest();
    AppId = ES_UT_MakeAppIdForIndex(99999);
    UT_Report(__FILE__, __LINE__, CFE_ES_GetAppName(AppName, AppId, 32) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
    ...
    AppId = CFE_ES_AppRecordGetID(UtAppRecPtr);
    UT_Report(__FILE__, __LINE__, CFE_ES_GetAppName(AppName, AppId, 32) == CFE_SUCCESS, "CFE_ES_GetAppName",
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_TaskCreate), OS_ERROR);
    Return = CFE_ES_CreateChildTask(&TaskId, "TaskName", TestAPI, StackBuf, sizeof(StackBuf), 400, 0);
    UT_Report(__FILE__, __LINE__, Return == CFE_ES_ERR_CHILD_TASK_CREATE, "CFE_ES_ChildTaskCreate",
    ...
    UT_Report(__FILE__, __LINE__,
              ...
              "CFE_ES_LockSharedData", "Mutex take error");
    ...
    UT_Report(__FILE__, __LINE__,
              ...
              "CFE_ES_UnlockSharedData", "Mutex release error");
    ...
    ES_UT_SetupSingleAppId(CFE_ES_AppType_EXTERNAL, CFE_ES_AppState_RUNNING, "UT", &UtAppRecPtr, &UtTaskRecPtr);
    TaskId = CFE_ES_TaskRecordGetID(UtTaskRecPtr);
    UtAssert_INT32_EQ(CFE_ES_GetTaskName(AppName, CFE_ES_RESOURCEID_UNDEFINED, sizeof(AppName)),
                      CFE_ES_ERR_RESOURCEID_NOT_VALID);
...
void TestGenericCounterAPI(void)
{
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_DeleteGenCounter(CFE_ES_RESOURCEID_UNDEFINED) == CFE_ES_BAD_ARGUMENT,
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_IncrementGenCounter(CFE_ES_RESOURCEID_UNDEFINED) == CFE_ES_BAD_ARGUMENT,
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_GetGenCount(CFE_ES_RESOURCEID_UNDEFINED, &CounterCount) == CFE_ES_BAD_ARGUMENT,
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_SetGenCount(CFE_ES_RESOURCEID_UNDEFINED, 5) == CFE_ES_BAD_ARGUMENT,
    ...
    UtAssert_INT32_EQ(CFE_ES_GetGenCounterName(CounterName, CFE_ES_RESOURCEID_UNDEFINED, sizeof(CounterName)),
                      CFE_ES_ERR_RESOURCEID_NOT_VALID);
...
void TestCDS()
{
    ...
    UtAssert_True(CFE_ES_ResourceID_Equal(CDSHandle, CFE_ES_CDSBlockRecordGetID(UtCDSRegRecPtr)),
                  "CDS Handle IDs Match");
    UtAssert_INT32_EQ(CFE_ES_GetCDSBlockName(CDSName, CFE_ES_RESOURCEID_UNDEFINED, sizeof(CDSName)),
                      CFE_ES_ERR_RESOURCEID_NOT_VALID);
...
void TestESMempool(void)
{
    ...
    PoolPtr->PoolID = CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(PoolPtr->PoolID) ^
                                                    10); /* cause it to fail validation */
    UT_Report(__FILE__, __LINE__, CFE_ES_ValidateHandle(PoolID2) == false, "CFE_ES_ValidateHandle",
     ...
     */
    UT_Report(__FILE__, __LINE__,
              CFE_ES_GetMemPoolStats(&Stats, CFE_ES_RESOURCEID_UNDEFINED) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
    ...
    PoolPtr->PoolID =
        CFE_ES_ResourceID_FromInteger(CFE_ES_ResourceID_ToInteger(PoolPtr->PoolID) ^ 10); /* Repair Pool2 ID */
    ...
    UT_Report(__FILE__, __LINE__, CFE_ES_ValidateHandle(CFE_ES_RESOURCEID_UNDEFINED) == false, "CFE_ES_ValidateHandle",
              "NULL handle");
    ...
    ES_ResetUnitTest();
    UT_Report(__FILE__, __LINE__,
              CFE_ES_GetPoolBuf(&addressp2, CFE_ES_RESOURCEID_UNDEFINED, 256) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
              "CFE_ES_GetPoolBuf", "NULL memory handle");

    /* Test getting the size of an existing pool buffer using a null handle */
    UT_Report(__FILE__, __LINE__,
              CFE_ES_GetPoolBufInfo(CFE_ES_RESOURCEID_UNDEFINED, addressp1) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_ES_PutPoolBuf(CFE_ES_RESOURCEID_UNDEFINED, addressp1) == CFE_ES_ERR_RESOURCEID_NOT_VALID,
