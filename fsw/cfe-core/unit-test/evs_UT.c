...
void Test_Init(void)
{
    ...
    strncpy((char *)appbitcmd.Payload.AppName, "ut_cfe_evs", sizeof(appbitcmd.Payload.AppName));
    ...
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[1]), "CFE_EVS_EarlyInit",
    ...
    CFE_EVS_EarlyInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[6]), "CFE_EVS_EarlyInit", "Event log restored");

    /* Test early initialization, clearing the event log (log mode path) */
    UT_InitData();
    UT_SetDeferredRetcode(UT_KEY(CFE_ES_GetResetType), 1, -1);
    CFE_EVS_GlobalData.EVS_LogPtr->LogMode     = CFE_EVS_LogMode_OVERWRITE + CFE_EVS_LogMode_DISCARD + 1;
    CFE_EVS_GlobalData.EVS_LogPtr->LogFullFlag = false;
    CFE_EVS_GlobalData.EVS_LogPtr->Next        = CFE_PLATFORM_EVS_LOG_MAX - 1;
    CFE_EVS_EarlyInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[5]), "CFE_EVS_EarlyInit",
    ...
    CFE_EVS_EarlyInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[3]), "CFE_EVS_EarlyInit",
    ...
    CFE_EVS_EarlyInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[2]), "CFE_EVS_EarlyInit",
    ...
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[11]), "CFE_EVS_TaskInit",
    ...
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[12]), "CFE_EVS_TaskInit",
    ...
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[13]), "CFE_EVS_TaskInit",
    ...
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[14]), "CFE_EVS_TaskInit",
    ...
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_SyslogIsInHistory(EVS_SYSLOG_MSGS[10]), "CFE_EVS_TaskInit",
              "Call to CFE_ES_GetAppID Failed");

    /* Test successful task initialization */
    UT_InitData();
    CFE_EVS_TaskInit();
    UT_Report(__FILE__, __LINE__, UT_GetStubCount(UT_KEY(CFE_ES_WriteToSysLog)) == 0, "CFE_EVS_TaskInit",
              "Normal init (WARM)");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAAPPEVTTYPE_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable debug message output");
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_DISABLE_PORTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_DISPORT_EID, "CFE_EVS_DisablePortsCmd",
              "Disable ports");
}
...
void Test_IllegalAppID(void)
{
    ...
    UT_InitData();
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendEvent(0, 0, "NULL") == CFE_EVS_APP_ILLEGAL_APP_ID, "CFE_EVS_SendEvent",
              "Illegal app ID");

    /* Test sending an event using an illegal application ID */
    UT_InitData();
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__, EVS_SendEvent(0, 0, "NULL") == CFE_SUCCESS, "EVS_SendEvent", "Illegal app ID");

    /* Test sending a timed event using an illegal application ID */
    UT_InitData();
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendTimedEvent(time, 0, 0, "NULL") == CFE_EVS_APP_ILLEGAL_APP_ID,
    ...
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendEventWithAppID(0, 0, CFE_ES_RESOURCEID_UNDEFINED, "NULL") == CFE_EVS_APP_ILLEGAL_APP_ID,
              "CFE_EVS_SendEventWithAppID", "Illegal app ID");

    /* Test resetting a filter using an illegal application ID */
    UT_InitData();
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetFilter(0) == CFE_EVS_APP_ILLEGAL_APP_ID, "CFE_EVS_ResetFilter",
              "Illegal app ID");
    ...
    UT_InitData();
    UT_SetDefaultReturnValue(UT_KEY(CFE_ES_AppID_ToIndex), CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_Report(__FILE__, __LINE__, CFE_EVS_CleanUpApp(CFE_ES_RESOURCEID_UNDEFINED) == CFE_EVS_APP_ILLEGAL_APP_ID,
              "CFE_EVS_CleanUpApp", "Illegal app ID");
}
...
void Test_UnregisteredApp(void)
{
    ...
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendEvent(0, 0, "NULL") == CFE_EVS_APP_NOT_REGISTERED, "CFE_EVS_SendEvent",
              "App not registered");

    /* Test resetting a filter using an unregistered application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetFilter(0) == CFE_EVS_APP_NOT_REGISTERED, "CFE_EVS_ResetFilter",
              "App not registered");

    /* Test resetting all filters using an unregistered application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetAllFilters() == CFE_EVS_APP_NOT_REGISTERED, "CFE_EVS_ResetAllFilters",
              "App not registered");

    /* Test sending an event with app ID to an unregistered application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendEventWithAppID(0, CFE_EVS_EventType_INFORMATION, AppID, "NULL") == CFE_EVS_APP_NOT_REGISTERED,
              "CFE_EVS_SendEventWithAppID", "App not registered");

    /* Test sending a timed event to an unregistered application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendTimedEvent(time, CFE_EVS_EventType_INFORMATION, 0, "NULL") == CFE_EVS_APP_NOT_REGISTERED,
              "CFE_EVS_SendTimedEvent", "App not registered");

    /* Test application cleanup using an unregistered application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_CleanUpApp(AppID) == CFE_SUCCESS, "CFE_EVS_CleanUpApp", "App not registered");
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(NULL, 0, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
              "CFE_EVS_Register", "Register app - successful");
}
...
void Test_FilterRegistration(void)
{
    ...
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(NULL, 0, CFE_EVS_EventFilter_BINARY + 1) == CFE_EVS_UNKNOWN_FILTER,
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(filter, 1, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_Register(filter, CFE_PLATFORM_EVS_MAX_EVENT_FILTERS + 1, CFE_EVS_EventFilter_BINARY) ==
                  CFE_SUCCESS,
              "CFE_EVS_Register", "Valid over max filters");

    /* Send 1st information message, should get through */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendEvent(0, CFE_EVS_EventType_INFORMATION, "OK") == CFE_SUCCESS,
              "CFE_EVS_SendEvent", "1st info message should go through");

    /* Send 2nd information message, should be filtered */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendEvent(0, CFE_EVS_EventType_INFORMATION, "FAILED") == CFE_SUCCESS,
    ...
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(NULL, 0, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
              "FE_EVS_Register", "Re-register application");
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendEventWithAppID(0, CFE_EVS_EventType_INFORMATION, AppID, "NULL") == CFE_SUCCESS,
              "CFE_EVS_SendEventWithAppID", "Application registered and filtered");

    /* Test sending a timed event to a registered, filtered application */
    UT_InitData();
    AppDataPtr->AppID      = AppID;
    AppDataPtr->ActiveFlag = false;
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendTimedEvent(time, CFE_EVS_EventType_INFORMATION, 0, "NULL") == CFE_SUCCESS,
              "CFE_EVS_SendTimedEvent", "Application registered and filtered");
}
...
void Test_FilterReset(void)
{
    ...
    filter.Mask    = 0x0001;
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(&filter, 1, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
              "CFE_EVS_Register", "Register filter - successful");

    /* Test filter reset using an invalid event ID */
    UT_InitData();
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_ResetFilter(CFE_PLATFORM_EVS_MAX_EVENT_FILTERS + 1) == CFE_EVS_EVT_NOT_REGISTERED,
              "CFE_EVS_ResetFilter", "Invalid event ID");

    /* Test filter reset using an unregistered event ID */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetFilter(-1) == CFE_SUCCESS, "CFE_EVS_ResetFilter",
              "Unregistered event ID");

    /* Test successful filter reset */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetFilter(1) == CFE_SUCCESS, "CFE_EVS_ResetFilter", "Valid reset filter");

    /* Test successful reset of all filters */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_ResetAllFilters() == CFE_SUCCESS, "CFE_EVS_ResetAllFilters",
              "Valid reset all filters");

    /* Return application to original state: re-register application */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(NULL, 0, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
              "CFE_EVS_Register", "Re-register app");
}
...
void Test_Format(void)
{
    ...
    UT_EVS_DoDispatchCheckEvents(&modecmd, sizeof(modecmd), UT_TPID_CFE_EVS_CMD_SET_EVENT_FORMAT_MODE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLEGALFMTMOD_EID,
              "CFE_EVS_SetEventFormatModeCmd", "Set event format mode command: invalid event format mode = 0xff");
    ...
    UT_EVS_DoDispatchCheckEventsShort(&modecmd, sizeof(modecmd), UT_TPID_CFE_EVS_CMD_SET_EVENT_FORMAT_MODE_CC,
                                      &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_SETEVTFMTMOD_EID, "CFE_EVS_SetEventFormatModeCmd",
    ...
    UT_Report(__FILE__, __LINE__, EventID[0] == 0 && EventID[1] == 0 && CapturedMsg.EventID == 0,
              "CFE_EVS_SetEventFormatModeCmd", "Long event format mode verification");
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_SendEvent(0, CFE_EVS_EventType_INFORMATION, "%s", long_msg) == CFE_SUCCESS,
              "CFE_EVS_SendEvent", "Sent info message with > maximum string length");

    /* Test sending an event with application ID using a string length
     * greater than the maximum allowed
     */
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendEventWithAppID(0, CFE_EVS_EventType_INFORMATION, AppID, "%s", long_msg) == CFE_SUCCESS,
              "CFE_EVS_SendEventWithAppID", "Sent info message with > maximum string length");

    /* Test sending a timed event using a string length greater than
     * the maximum allowed
     */
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_SendTimedEvent(time, 0, CFE_EVS_EventType_INFORMATION, "%s", long_msg) == CFE_SUCCESS,
              "CFE_EVS_SendTimedEvent", "Sent info message with > maximum string length");
}
...
void Test_Ports(void)
{
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_PORTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__,
              UT_EVS_EventBuf.EventID == CFE_EVS_ENAPORT_EID && UT_GetStubCount(UT_KEY(OS_printf)) == 4,
              "CFE_EVS_EnablePortsCmd", "Enable ports command received with port bit mask = 0x0f");
    ...
    UT_Report(__FILE__, __LINE__, LocalSnapshotData.Count == 1 && UT_GetStubCount(UT_KEY(OS_printf)) == 4,
              "CFE_EVS_EnablePortsCmd", "Test ports output");
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_PORTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID, "CFE_EVS_EnablePortsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_DISABLE_PORTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID, "CFE_EVS_DisablePortsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_PORTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAPORT_EID, "CFE_EVS_EnablePortsCmd",
...
void Test_Logging(void)
{
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.modecmd, sizeof(CmdBuf.modecmd), UT_TPID_CFE_EVS_CMD_SET_LOG_MODE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_NO_LOGSET_EID, "CFE_EVS_SetLoggingModeCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.modecmd, sizeof(CmdBuf.modecmd), UT_TPID_CFE_EVS_CMD_SET_LOG_MODE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_LOGMODE_EID, "CFE_EVS_SetLogModeCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.modecmd, sizeof(CmdBuf.modecmd), UT_TPID_CFE_EVS_CMD_SET_LOG_MODE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_LOGMODE_EID, "CFE_EVS_SetLogModeCmd",
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_GlobalData.EVS_LogPtr->LogFullFlag == true &&
                  CFE_EVS_GlobalData.EVS_LogPtr->LogMode == CFE_EVS_LogMode_DISCARD,
              "CFE_EVS_SendEvent", "Log overfill event (discard mode)");
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_GlobalData.EVS_LogPtr->LogFullFlag == true &&
                  CFE_EVS_GlobalData.EVS_LogPtr->LogMode == CFE_EVS_LogMode_OVERWRITE,
              "CFE_EVS_SetLogModeCmd", "Log overfill event (overwrite mode)");
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_NO_LOGWR_EID, "CFE_EVS_WriteLogDataFileCmd",
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_NO_LOGCLR_EID, "EVS_ClearLog",
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_NOOP_EID, "CFE_EVS_ProcessGroundCommand",
              "No-op command");
    ...
    CFE_EVS_GlobalData.EVS_TlmPkt.Payload.LogEnabled = true;
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.cmd, sizeof(CmdBuf.cmd), UT_TPID_CFE_EVS_CMD_CLEAR_LOG_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, CFE_EVS_GlobalData.EVS_LogPtr->LogFullFlag == false, "EVS_ClearLog", "Clear log");
    ...
    CFE_EVS_GlobalData.EVS_LogPtr  = &CFE_EVS_ResetDataPtr->EVS_Log;
    CmdBuf.modecmd.Payload.LogMode = CFE_EVS_LogMode_OVERWRITE;
    UT_Report(__FILE__, __LINE__, CFE_EVS_SetLogModeCmd(&CmdBuf.modecmd) == CFE_SUCCESS, "CFE_EVS_SetLogModeCmd",
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteLogDataFileCmd(&CmdBuf.logfilecmd) != CFE_SUCCESS,
              "CFE_EVS_WriteLogDataFileCmd", "OS create fail");
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteLogDataFileCmd(&CmdBuf.logfilecmd) == CFE_SUCCESS,
              "CFE_EVS_WriteLogDataFileCmd", "Write all event log entries");
    ...
    CFE_EVS_GlobalData.EVS_LogPtr->LogCount = CFE_PLATFORM_EVS_LOG_MAX;
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteLogDataFileCmd(&CmdBuf.logfilecmd) != CFE_SUCCESS,
              "CFE_EVS_WriteLogDataFileCmd", "OS write fail");
    ...
    UT_InitData();
    UT_SetDeferredRetcode(UT_KEY(OS_MutSemCreate), 1, OS_SUCCESS);
    strncpy((char *)CmdBuf.logfilecmd.Payload.LogFilename, "LogFile", sizeof(CmdBuf.logfilecmd.Payload.LogFilename));
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteLogDataFileCmd(&CmdBuf.logfilecmd) == CFE_SUCCESS,
              "CFE_EVS_WriteLogDataFileCmd", "Write single event log entry - successful (log name specified)");
    ...
    CmdBuf.logfilecmd.Payload.LogFilename[0] = '\0';
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteLogDataFileCmd(&CmdBuf.logfilecmd) != CFE_SUCCESS,
              "CFE_EVS_WriteLogDataFileCmd", "Write single event log entry - write header failed");
}
...
void Test_WriteApp(void)
{
    ...
    UT_InitData();
    memset(&CmdBuf, 0, sizeof(CmdBuf));
    strncpy((char *)CmdBuf.appbitcmd.Payload.AppName, "ut_cfe_evs", sizeof(CmdBuf.appbitcmd.Payload.AppName));
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.cmd, sizeof(CmdBuf.cmd), UT_TPID_CFE_EVS_CMD_RESET_COUNTERS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_RSTCNT_EID, "CFE_EVS_ResetCountersCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.AppDataCmd, sizeof(CmdBuf.AppDataCmd),
                                 UT_TPID_CFE_EVS_CMD_WRITE_APP_DATA_FILE_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_WRDATFILE_EID, "CFE_EVS_WriteAppDataFileCmd",
              "OS write fail");
    ...
    UT_EVS_DoDispatchCheckEvents(&CmdBuf.AppDataCmd, sizeof(CmdBuf.AppDataCmd),
                                 UT_TPID_CFE_EVS_CMD_WRITE_APP_DATA_FILE_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_WRDAT_EID, "CFE_EVS_WriteAppDataFileCmd",
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_WriteAppDataFileCmd(&CmdBuf.AppDataCmd) != CFE_SUCCESS,
              "CFE_EVS_WriteAppDataFileCmd", "Write application data - write header failed");
}
...
void Test_BadAppCmd(void)
{
    ...
    strncpy((char *)appbitcmd.Payload.AppName, "unknown_name", sizeof(appbitcmd.Payload.AppName));
    strncpy((char *)appnamecmd.Payload.AppName, "unknown_name", sizeof(appnamecmd.Payload.AppName));
    strncpy((char *)appmaskcmd.Payload.AppName, "unknown_name", sizeof(appmaskcmd.Payload.AppName));
    strncpy((char *)appcmdcmd.Payload.AppName, "unknown_name", sizeof(appcmdcmd.Payload.AppName));
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID,
              "CFE_EVS_DisableAppEventTypesCmd", "Unable to retrieve application ID while disabling event types");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Unable to retrieve application ID while enabling event types");
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID,
              "CFE_EVS_DisableAppEventsCmd", "Unable to retrieve application ID while disabling events");
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID, "CFE_EVS_EnableAppEventsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_APP_COUNTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID,
              "CFE_EVS_ResetAppEventCounterCmd", "Unable to retrieve application ID while resetting events");
    ...
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID, "CFE_EVS_AddEventFilterCmd",
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID, "CFE_EVS_SetFilterMaskCmd",
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID, "CFE_EVS_ResetFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_ALL_FILTERS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_NOAPPIDFOUND_EID, "CFE_EVS_ResetAllFiltersCmd",
    ...
    UT_InitData();
    strncpy((char *)appbitcmd.Payload.AppName, "illegal_id", sizeof(appbitcmd.Payload.AppName));
    strncpy((char *)appnamecmd.Payload.AppName, "illegal_id", sizeof(appnamecmd.Payload.AppName));
    strncpy((char *)appmaskcmd.Payload.AppName, "illegal_id", sizeof(appmaskcmd.Payload.AppName));
    strncpy((char *)appcmdcmd.Payload.AppName, "illegal_id", sizeof(appcmdcmd.Payload.AppName));
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Illegal application ID while enabling application event types");
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
              "CFE_EVS_DisableAppEventsCmd", "Illegal application ID while disabling application events");
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
              "CFE_EVS_EnableAppEventsCmd", "Illegal application ID while enabling application events");
    ...
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID, "CFE_EVS_AddEventFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_DELETE_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
              "CFE_EVS_DeleteEventFilterCmd", "Illegal application ID while deleting the event filter");

    /* Test setting the filter mask with an illegal application ID */
    UT_InitData();
    UT_SetDeferredRetcode(UT_KEY(CFE_ES_AppID_ToIndex), 1, CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_SET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID, "CFE_EVS_SetFilterMaskCmd",
    ...
    UT_SetDeferredRetcode(UT_KEY(CFE_ES_AppID_ToIndex), 1, CFE_ES_ERR_RESOURCEID_NOT_VALID);
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_RESET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID, "CFE_EVS_ResetFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_ALL_FILTERS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_ILLAPPIDRANGE_EID,
              "CFE_EVS_ResetAllFiltersCmd", "Illegal application ID while resetting all filters");
    ...
    strncpy((char *)appbitcmd.Payload.AppName, "unregistered_app", sizeof(appbitcmd.Payload.AppName));
    strncpy((char *)appnamecmd.Payload.AppName, "unregistered_app", sizeof(appnamecmd.Payload.AppName));
    strncpy((char *)appmaskcmd.Payload.AppName, "unregistered_app", sizeof(appmaskcmd.Payload.AppName));
    strncpy((char *)appcmdcmd.Payload.AppName, "unregistered_app", sizeof(appcmdcmd.Payload.AppName));
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID,
              "CFE_EVS_DisableAppEventTypesCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_DisableAppEventsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_EnableAppEventsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_AddEventFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_DELETE_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_DeleteEventFilterCmd",
    ...
    UT_SetDataBuffer(UT_KEY(CFE_ES_AppID_ToIndex), &TestAppIndex, sizeof(TestAppIndex), false);
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_SET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_SetFilterMaskCmd",
    ...
    UT_SetDataBuffer(UT_KEY(CFE_ES_AppID_ToIndex), &TestAppIndex, sizeof(TestAppIndex), false);
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_RESET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_ResetFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_ALL_FILTERS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_APPNOREGS_EID, "CFE_EVS_ResetAllFiltersCmd",
...
void Test_EventCmd(void)
{
    ...
    strncpy((char *)appbitcmd.Payload.AppName, "ut_cfe_evs", sizeof(appbitcmd.Payload.AppName));
    strncpy((char *)appnamecmd.Payload.AppName, "ut_cfe_evs", sizeof(appnamecmd.Payload.AppName));
    ...
    UT_Report(__FILE__, __LINE__,
              UT_EVS_EventBuf.EventID == 0xFFFF && EventCount[0] == 0 && EventCount[1] == 0 && EventCount[2] == 0 &&
                  EventCount[3] == 0,
              "CFE_EVS_SendEvent", "Disable all events");
    ...
    EventCount[3] = LocalSnapshotData.Count;
    UT_Report(__FILE__, __LINE__,
              UT_EVS_EventBuf.EventID == CFE_EVS_ENAAPPEVTTYPE_EID && EventCount[0] == 1 && EventCount[1] == 2 &&
                  EventCount[2] == 3 && EventCount[3] == 4,
              "CFE_EVS_SendEvent", "Enable all event types");
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_DisableAppEventTypesCmd", "Disable events using an illegal event type");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable events using an illegal event type");

    /* Test successful disabling of application events */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == 0xFFFF, "CFE_EVS_DisableAppEventsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENTS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAAPPEVT_EID, "CFE_EVS_EnableAppEventsCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_DISABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_DISEVTTYPE_EID, "CFE_EVS_DisableEventTypesCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAEVTTYPE_EID, "CFE_EVS_EnableEventTypesCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_APP_COUNTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_RSTEVTCNT_EID, "CFE_EVS_ResetAppEventCounterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_DISABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_DisableEventTypesCmd", "Disable event types - bit mask out of range (high)");
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_EnableEventTypesCmd", "Enable event types - bit mask out of range (high)");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable application event types - bit mask out of range (high)");
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_DISABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_DisableEventTypesCmd", "Disable event types - bit mask out of range (low)");
    ...
    UT_EVS_DoDispatchCheckEvents(&bitmaskcmd, sizeof(bitmaskcmd), UT_TPID_CFE_EVS_CMD_ENABLE_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_EnableEventTypesCmd", "Enable event types - bit mask out of range (low)");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_DISABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_DisableAppEventTypesCmd", "Disable application event types - bit mask out of range (low)");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_INVALID_BITMASK_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable application event types - bit mask out of range (low)");
}
...
void Test_FilterCmd(void)
{
    ...
    /* Run the next series of tests with valid, registered application name */
    strncpy((char *)appnamecmd.Payload.AppName, "ut_cfe_evs", sizeof(appnamecmd.Payload.AppName));
    strncpy((char *)appmaskcmd.Payload.AppName, "ut_cfe_evs", sizeof(appmaskcmd.Payload.AppName));
    strncpy((char *)appcmdcmd.Payload.AppName, "ut_cfe_evs", sizeof(appcmdcmd.Payload.AppName));
    strncpy((char *)appbitcmd.Payload.AppName, "ut_cfe_evs", sizeof(appbitcmd.Payload.AppName));
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAAPPEVTTYPE_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable all application event types - successful");

    /* Ensure there is no filter for the next tests */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_DELETE_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_EVTIDNOREGS_EID,
              "CFE_EVS_DeleteEventFilterCmd", "Delete event filter - successful");
    ...
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_SET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_EVTIDNOREGS_EID, "CFE_EVS_SetFilterMaskCmd",
    ...
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_RESET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_EVTIDNOREGS_EID, "CFE_EVS_ResetFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appnamecmd, sizeof(appnamecmd), UT_TPID_CFE_EVS_CMD_RESET_ALL_FILTERS_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_RSTALLFILTER_EID, "CFE_EVS_ResetAllFiltersCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ADDFILTER_EID, "CFE_EVS_AddEventFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_EVT_FILTERED_EID, "CFE_EVS_AddEventFilterCmd",
              "Add event filter - event already registered for filtering");

    /* Test successfully setting a filter mask */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_SET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_SETFILTERMSK_EID, "CFE_EVS_SetFilterMaskCmd",
              "Set filter mask - successful");

    /* Test successfully resetting a filter mask */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_RESET_FILTER_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_RSTFILTER_EID, "CFE_EVS_ResetFilterCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&appcmdcmd, sizeof(appcmdcmd), UT_TPID_CFE_EVS_CMD_DELETE_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_DELFILTER_EID, "CFE_EVS_DeleteEventFilterCmd",
    ...
    UT_Report(__FILE__, __LINE__,
              ...
              "CFE_EVS_AddEventFilterCmd", "Maximum event filters added");

    /* Test overfilling the event filters */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&appmaskcmd, sizeof(appmaskcmd), UT_TPID_CFE_EVS_CMD_ADD_EVENT_FILTER_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_MAXREGSFILTER_EID, "CFE_EVS_AddEventFilterCmd",
    ...
    appmaskcmd.Payload.EventID = 0;
    UT_Report(__FILE__, __LINE__, CFE_EVS_Register(NULL, 0, CFE_EVS_EventFilter_BINARY) == CFE_SUCCESS,
              "CFE_EVS_Register", "Register application - successful");
    ...
    UT_EVS_DoDispatchCheckEvents(&appbitcmd, sizeof(appbitcmd), UT_TPID_CFE_EVS_CMD_ENABLE_APP_EVENT_TYPE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ENAAPPEVTTYPE_EID,
              "CFE_EVS_EnableAppEventTypesCmd", "Enable all application event message output");
...
void Test_InvalidCmd(void)
{
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_MSGID_EID, "CFE_EVS_ProcessGroundCommand",
              "Invalid command packet");
    ...
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_ERR_CC_EID, "CFE_EVS_ProcessGroundCommand",
              "Invalid command");

    /* Test invalid command length event */
    UT_InitData();
    UT_EVS_DoDispatchCheckEvents(&cmd, 0, UT_TPID_CFE_EVS_CMD_NOOP_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == CFE_EVS_LEN_ERR_EID, "CFE_EVS_VerifyCmdLength",
...
void Test_Misc(void)
{
    ...
    UT_EVS_DoDispatchCheckEvents(&PktBuf.writelogdatacmd, sizeof(PktBuf.writelogdatacmd),
                                 UT_TPID_CFE_EVS_CMD_WRITE_LOG_DATA_FILE_CC, &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == 0xFFFF, "CFE_EVS_WriteLogDataFileCmd",
    ...
    UT_EVS_DoDispatchCheckEvents(&PktBuf.modecmd, sizeof(PktBuf.modecmd), UT_TPID_CFE_EVS_CMD_SET_LOG_MODE_CC,
                                 &UT_EVS_EventBuf);
    UT_Report(__FILE__, __LINE__, UT_EVS_EventBuf.EventID == 0xFFFF, "CFE_EVS_SetLogModeCmd",
    ...
    UT_Report(__FILE__, __LINE__, HK_SnapshotData.Count == 1, "CFE_EVS_ReportHousekeepingCmd",
              "Housekeeping report - successful (log enabled)");

    /* Test successful application cleanup */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_EVS_CleanUpApp(CFE_ES_RESOURCEID_UNDEFINED) == CFE_SUCCESS, "CFE_EVS_CleanUpApp",
     ...
     */
    UT_InitData();
    CFE_EVS_GlobalData.EVS_TlmPkt.Payload.MessageSendCounter = CFE_EVS_MAX_EVENT_SEND_COUNT;
    AppDataPtr->EventCount                                   = CFE_EVS_MAX_EVENT_SEND_COUNT;
    EVS_SendEvent(0, 0, "Max Event Count");
    UT_Report(__FILE__, __LINE__,
              CFE_EVS_GlobalData.EVS_TlmPkt.Payload.MessageSendCounter == CFE_EVS_MAX_EVENT_SEND_COUNT &&
                  AppDataPtr->EventCount == CFE_EVS_MAX_EVENT_SEND_COUNT,
              "EVS_SendEvent", "Maximum message count and event count");
    ...
    UT_Report(__FILE__, __LINE__, CFE_EVS_GlobalData.EVS_TlmPkt.Payload.MessageTruncCounter == 1, "EVS_SendEvent",
