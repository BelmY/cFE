...
void Test_ConvertTime(void)
{
     ...
     */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_TIME_Sub2MicroSecs(0xffff) == 16, "CFE_TIME_Sub2MicroSecs",
     ...
     */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_TIME_Sub2MicroSecs(0x80002000) == 500001, "CFE_TIME_Sub2MicroSecs",
              "-1 microsecond adjustment");
    ...
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_TIME_Micro2SubSecs(0xffff) == 281468928, "CFE_TIME_Micro2SubSecs",
     ...
     */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_TIME_Micro2SubSecs(999998) == 0xffffe000, "CFE_TIME_Micro2SubSecs",
     ...
     */
    UT_InitData();
    UT_Report(__FILE__, __LINE__, CFE_TIME_Micro2SubSecs(999999) == 0xfffff000, "CFE_TIME_Micro2SubSecs",
...
void Test_ExternalTone(void)
{
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_TIME_TaskData.ToneSignalLatch.Seconds == 123 && CFE_TIME_TaskData.ToneSignalLatch.Subseconds == 0,
...
void Test_External(void)
{
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ExternalCount == 1, "CFE_TIME_ExternalMET",
    ...
    UT_SetBSP_Time(0, 0);
    CFE_TIME_ExternalMET(settime);
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.InternalCount == 1, "CFE_TIME_ExternalMET",
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ExternalCount == 1, "CFE_TIME_ExternalGPS",
    ...
    UT_SetBSP_Time(0, 0);
    CFE_TIME_ExternalGPS(settime, 0);
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.InternalCount == 1, "CFE_TIME_ExternalGPS",
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ExternalCount == 1, "CFE_TIME_ExternalTime",
    ...
    UT_SetBSP_Time(0, 0);
    CFE_TIME_ExternalTime(settime);
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.InternalCount == 1, "CFE_TIME_ExternalTime",
...
void Test_PipeCmds(void)
{
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ToneSignalCounter == 1, "CFE_TIME_ToneSignalCmd",
              "Time at tone signal");
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ToneDataCounter == 1, "CFE_TIME_ToneDataCmd", "Time at tone data");
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              !UT_EventIsInHistory(CFE_TIME_ID_ERR_EID) && CFE_TIME_TaskData.InternalCount == count + 1,
...
#if (CFE_PLATFORM_TIME_CFG_SIGNAL == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_SIGNAL_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetSignalCmd", "Set tone signal source = primary");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_SIGNAL_CFG_EID) && CFE_TIME_TaskData.CommandErrorCounter == 1,
    ...
    UT_CallTaskPipe(CFE_TIME_TaskPipe, &CmdBuf.message, sizeof(CmdBuf.signalcmd), UT_TPID_CFE_TIME_CMD_SET_SIGNAL_CC);
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_SIGNAL_ERR_EID) && CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_CLIENT == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_DELAY_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetDelayCmd", "Set tone add delay");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_DELAY_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_TIME_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetTimeCmd", "Set time");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_TIME_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_MET_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetMETCmd", "Set MET");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_MET_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_STCF_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetSTCFCmd", "Set STCF");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_STCF_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_DELTA_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_AdjustCmd", "Set STCF adjust positive");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_DELTA_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_1HZ_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_1HzAdjCmd", "Set STCF 1Hz adjust positive");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_1HZ_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
#if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_LEAPS_EID) && CFE_TIME_TaskData.CommandCounter == 1 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 0,
              "CFE_TIME_SetLeapSecondsCmd", "Set leap seconds");
#else
    UT_Report(__FILE__, __LINE__,
              UT_EventIsInHistory(CFE_TIME_LEAPS_CFG_EID) && CFE_TIME_TaskData.CommandCounter == 0 &&
                  CFE_TIME_TaskData.CommandErrorCounter == 1,
...
void Test_ResetArea(void)
{
    ...
    UT_Report(__FILE__, __LINE__, UT_GetResetDataPtr()->TimeResetVars.ClockSignal == CFE_TIME_TaskData.ClockSignal,
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.DataStoreStatus == CFE_TIME_RESET_AREA_EXISTING,
    ...
    CFE_TIME_QueryResetVars();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.DataStoreStatus == CFE_TIME_RESET_AREA_BAD,
              "CFE_TIME_QueryResetVars", "Reset area error");
    ...
    CFE_TIME_QueryResetVars();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.DataStoreStatus == CFE_TIME_RESET_AREA_NEW,
              "CFE_TIME_QueryResetVars", "Initialize to default values");
    ...
    CFE_TIME_QueryResetVars();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.DataStoreStatus == CFE_TIME_RESET_AREA_NEW,
              "CFE_TIME_QueryResetVars", "Bad clock signal selection");
...
void Test_Tone(void)
{
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Seconds == CFE_MAKE_BIG32(virtualSeconds) &&
                  CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Subseconds ==
                      CFE_MAKE_BIG32(0), /* yes, I know, 0 is 0 in all endians */
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Seconds == virtualSeconds &&
                  CFE_TIME_TaskData.ToneDataCmd.Payload.AtToneMET.Subseconds == 0,
              "CFE_TIME_ToneSend", "Send tone, flywheel OFF");
    ...
    UT_Report(__FILE__, __LINE__,
              CFE_TIME_TaskData.LastVersionCounter > VersionSave && CFE_TIME_TaskData.ToneMatchCounter == 1,
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ToneMatchErrorCounter == 1, "CFE_TIME_ToneVerify",
    ...
    CFE_TIME_TaskData.ToneMatchCounter         = 0;
    CFE_TIME_ToneVerify(time1, time2);
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ToneMatchCounter == 1, "CFE_TIME_ToneVerify",
    ...
    CFE_TIME_TaskData.ServerFlyState = CFE_TIME_FlywheelState_NO_FLY;
    CFE_TIME_ToneUpdate();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ServerFlyState == CFE_TIME_FlywheelState_IS_FLY,
...
void Test_1Hz(void)
{
    ...
    CFE_TIME_TaskData.MaxLocalClock.Subseconds = 0;
    CFE_TIME_Local1HzStateMachine();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.AutoStartFly == true, "CFE_TIME_Local1HzISR",
    ...
    CFE_TIME_TaskData.ToneSignalLatch.Subseconds = 0;
    CFE_TIME_Tone1HzISR();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.IsToneGood == false, "CFE_TIME_Tone1HzISR",
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.LocalTaskCounter == 1, "CFE_TIME_Local1HzTask",
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.ToneTaskCounter == 1, "CFE_TIME_Tone1HzTask",
              "Semaphore creation pass, then fail");
    ...
    CFE_TIME_TaskData.ToneSignalLatch.Subseconds = 0;
    CFE_TIME_Tone1HzISR();
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.IsToneGood == true, "CFE_TIME_Tone1HzISR",
    ...
    UT_Report(__FILE__, __LINE__, CFE_TIME_TaskData.LocalIntCounter == 2, "CFE_TIME_Local1HzTimerCallback",
